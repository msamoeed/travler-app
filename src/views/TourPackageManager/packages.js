...
function insertPackage(values) {
  ...
  var postData = {
    ...
    pickUpcity: values.address,
    tourManager: localStorage.getItem("uid"),
  ...
  axios.post("http://localhost:5556/createTour", postData, headers)
...
function cancelBooking(id){
  ...
  axios.delete("http://localhost:5556/package/deletePackage/" + id ,  headers)
    ...
    <div className={classes.root}>
      <AppBar position="static">
        <Tabs value={value} onChange={handleChange} aria-label="simple tabs example">
          <Tab label="Your Packages" {...a11yProps(0)} />
          <Tab label="Register Package" {...a11yProps(1)} />
