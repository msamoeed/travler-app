...
function insertHotel (values) {
  ...
  axios
    .post('http://localhost:5556/addhotel', postData, headers)
...
function cancelBooking (id) {
  ...
  axios
    .delete('http://localhost:5556/hotel/delete/' + id, headers)
...
export default function HotelsScreen () {
  ...
  function getList () {
    return fetch(
      'http://localhost:5556/gethotelByHotelId/' + localStorage.getItem('uid')
    ).then(data => data.json())
  }
